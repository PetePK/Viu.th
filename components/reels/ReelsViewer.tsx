...
export default function ReelsViewer({ reels, initialIndex, onClose, onWatchFull }: ReelsViewerProps) {
  ...
  return (
    <div ref={containerRef} className="rv-backdrop">
      {/* Close button */}
      <button type="button" onClick={onClose} className="rv-close-btn">
      ...
      <div className="rv-counter">
        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#FFBF00" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
          <rect x="2" y="2" width="20" height="20" rx="2" />
          <polygon points="10,8 16,12 10,16" fill="#FFBF00" stroke="none" />
        </svg>
        ...
        <div className="rv-video-container">
          ...
          <div className="rv-actions">
            ...
            <button type="button" onClick={toggleLike} className="rv-action-btn">
              ...
              <span className="rv-action-label">{isLiked ? '2.4K' : '2.3K'}</span>
            </button>
            ...
            <button type="button" onClick={() => setShowComments(!showComments)} className="rv-action-btn">
              ...
              <span className="rv-action-label">128</span>
            </button>
